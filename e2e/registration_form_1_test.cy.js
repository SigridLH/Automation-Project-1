...
describe('This is first test suite, Sigrid Laas-Hurt', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //17.11.2023
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="firstName"]').type('Sigrid')
        cy.get('input[name="lastName"]').type('Laas-Hurt')
        cy.get('input[name="password"]').type('Password123SLH')
        cy.get('[name="confirm"]').type('Password123SLH')
